  ...
  return (
    <div>
      ...
      <div className="text-black  min-h-screen w-full p-5 mt-20">
        ...
        {/* ----- Key Objectives ----- */}
        <div className="relative mt-10 w-full h-[1300px] md:h-[550px] bg-contain  bg-no-repeat text-white bg-right flex flex-col justify-center items-center " style={{ backgroundImage: `url(${worker})` }}>
          ...
          <div className="relative flex flex-wrap justify-center gap-10 mt-10 pb-20">
            ...
            <div className=" p-[30px] rounded-[20px] shadow-lg border border-slate-300 text-center w-[250px] max-w-full">
              <div className="flex justify-center w-full mb-6">
                <MdVerifiedUser className="text-8xl text-primary" />
              </div>
              <h2 className="font-bold text-lg">Accelerate Productivity</h2>
              <p className="text-white text-sm mt-2 leading-relaxed text-gray-800">
