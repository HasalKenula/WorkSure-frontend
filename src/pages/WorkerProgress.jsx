...
//   // Grouped job request data
//   const jobGroups = [
//     {
//       title: "Approval Status",
//       items: [
//         { title: "Approved Job Requests", value: active, icon: <FaCheckCircle style={{ color: "#16a34a" }} /> },
//         { title: "Blocked Job Requests", value: blocked, icon: <FaBan style={{ color: "#dc2626" }} /> },
//       ],
//     },
//     {
//       title: "Pending Status",
//       items: [
//         { title: "Pending Job Requests", value: pending, icon: <FaClock style={{ color: "#ca8a04" }} /> },
//         { title: "Seen Job Requests", value: seen, icon: <FaEye style={{ color: "#2563eb" }} /> },
//       ],
//     },
//     {
//       title: "Work Status",
...
//         {/* Grouped Job Requests */}
//         <div className="max-w-7xl mx-auto mt-12 px-6 space-y-12 ">
//           {jobGroups.map((group, i) => (
//             <div key={i} className="flex flex-col items-center">
//               <h2 className="group-title">{group.title}</h2>
//               <div className="pdf-grid w-2/3">
//                 {group.items.map((item, j) => (
//                   <div
//                     key={j}
//                     className=" bg-white rounded-3xl border border-gray-300 flex flex-col items-center text-center p-6 gap-4"
//                   >
//                     <div
//                       style={{
//                         width: "48px",
