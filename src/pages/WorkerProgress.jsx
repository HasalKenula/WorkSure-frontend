      ...
      >
        ...
        <div className="max-w-7xl mx-auto mt-12 px-6">
          ...
          <div className="pdf-grid">
            {[
              { title: "Active", value: active, icon: <FaCheckCircle style={{ color: "#16a34a" }} /> },
              { title: "Blocked", value: blocked, icon: <FaBan style={{ color: "#dc2626" }} /> },
              { title: "Pending", value: pending, icon: <FaClock style={{ color: "#ca8a04" }} /> },
              { title: "Seen", value: seen, icon: <FaEye style={{ color: "#2563eb" }} /> },
